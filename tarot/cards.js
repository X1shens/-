...
const TAROT_CARDS = [
  ...
  { id:'major_00', name:{cn:'愚者',en:'The Fool'},         suit:'major', number:0,  rarity:'SR',
    visual:{ image:null, symbolKey:'fool',          palette:{bg:'#0a1628',primary:'#fbbf24',accent:'#38bdf8'} },
  ...
  { id:'major_01', name:{cn:'魔术师',en:'The Magician'},   suit:'major', number:1,  rarity:'SR',
    visual:{ image:null, symbolKey:'magician',      palette:{bg:'#1a0a2e',primary:'#ffd700',accent:'#dc2626'} },
  ...
  { id:'major_02', name:{cn:'女祭司',en:'The High Priestess'}, suit:'major', number:2, rarity:'SR',
    visual:{ image:null, symbolKey:'high_priestess', palette:{bg:'#0f1729',primary:'#c4b5fd',accent:'#60a5fa'} },
  ...
  { id:'major_03', name:{cn:'女皇',en:'The Empress'},      suit:'major', number:3,  rarity:'SR',
    visual:{ image:null, symbolKey:'empress',       palette:{bg:'#0d1f14',primary:'#86efac',accent:'#fbbf24'} },
  ...
  { id:'major_04', name:{cn:'皇帝',en:'The Emperor'},      suit:'major', number:4,  rarity:'SR',
    visual:{ image:null, symbolKey:'emperor',       palette:{bg:'#1f0a0a',primary:'#ef4444',accent:'#fbbf24'} },
  ...
  { id:'major_05', name:{cn:'教皇',en:'The Hierophant'},   suit:'major', number:5,  rarity:'R',
    visual:{ image:null, symbolKey:'hierophant',    palette:{bg:'#0a1229',primary:'#fbbf24',accent:'#c4b5fd'} },
  ...
  { id:'major_06', name:{cn:'恋人',en:'The Lovers'},       suit:'major', number:6,  rarity:'R',
    visual:{ image:null, symbolKey:'lovers',        palette:{bg:'#1f0a17',primary:'#f472b6',accent:'#fbbf24'} },
  ...
  { id:'major_07', name:{cn:'战车',en:'The Chariot'},      suit:'major', number:7,  rarity:'R',
    visual:{ image:null, symbolKey:'chariot',       palette:{bg:'#0a1525',primary:'#60a5fa',accent:'#fbbf24'} },
  ...
  { id:'major_08', name:{cn:'力量',en:'Strength'},         suit:'major', number:8,  rarity:'SR',
    visual:{ image:null, symbolKey:'strength',      palette:{bg:'#1f1207',primary:'#fb923c',accent:'#fbbf24'} },
  ...
  { id:'major_09', name:{cn:'隐士',en:'The Hermit'},       suit:'major', number:9,  rarity:'R',
    visual:{ image:null, symbolKey:'hermit',        palette:{bg:'#0d1520',primary:'#94a3b8',accent:'#c4b5fd'} },
  ...
  { id:'major_10', name:{cn:'命运之轮',en:'The Wheel of Fortune'}, suit:'major', number:10, rarity:'SSR',
    visual:{ image:null, symbolKey:'wheel',         palette:{bg:'#1a0a2e',primary:'#a855f7',accent:'#fbbf24'} },
  ...
  { id:'major_11', name:{cn:'正义',en:'Justice'},          suit:'major', number:11, rarity:'SR',
    visual:{ image:null, symbolKey:'justice',       palette:{bg:'#0f1520',primary:'#fbbf24',accent:'#6366f1'} },
  ...
  { id:'major_12', name:{cn:'倒吊人',en:'The Hanged Man'},  suit:'major', number:12, rarity:'R',
    visual:{ image:null, symbolKey:'hanged_man',    palette:{bg:'#0a1f1f',primary:'#2dd4bf',accent:'#c4b5fd'} },
  ...
  { id:'major_13', name:{cn:'死神',en:'Death'},            suit:'major', number:13, rarity:'SSR',
    visual:{ image:null, symbolKey:'death',         palette:{bg:'#080808',primary:'#e2e8f0',accent:'#dc2626'} },
  ...
  { id:'major_14', name:{cn:'节制',en:'Temperance'},       suit:'major', number:14, rarity:'R',
    visual:{ image:null, symbolKey:'temperance',    palette:{bg:'#0a1829',primary:'#7dd3fc',accent:'#fbbf24'} },
  ...
  { id:'major_15', name:{cn:'恶魔',en:'The Devil'},        suit:'major', number:15, rarity:'SSR',
    visual:{ image:null, symbolKey:'devil',         palette:{bg:'#100208',primary:'#dc2626',accent:'#9f1239'} },
  ...
  { id:'major_16', name:{cn:'塔',en:'The Tower'},          suit:'major', number:16, rarity:'SSR',
    visual:{ image:null, symbolKey:'tower',         palette:{bg:'#0a0a14',primary:'#f59e0b',accent:'#dc2626'} },
  ...
  { id:'major_17', name:{cn:'星星',en:'The Star'},         suit:'major', number:17, rarity:'SR',
    visual:{ image:null, symbolKey:'star',          palette:{bg:'#060d1f',primary:'#7dd3fc',accent:'#fbbf24'} },
  ...
  { id:'major_18', name:{cn:'月亮',en:'The Moon'},         suit:'major', number:18, rarity:'SSR',
    visual:{ image:null, symbolKey:'moon',          palette:{bg:'#06091a',primary:'#c4b5fd',accent:'#60a5fa'} },
  ...
  { id:'major_19', name:{cn:'太阳',en:'The Sun'},          suit:'major', number:19, rarity:'SR',
    visual:{ image:null, symbolKey:'sun',           palette:{bg:'#1a0f00',primary:'#fbbf24',accent:'#ef4444'} },
  ...
  { id:'major_20', name:{cn:'审判',en:'Judgement'},        suit:'major', number:20, rarity:'SR',
    visual:{ image:null, symbolKey:'judgement',     palette:{bg:'#0a0a1a',primary:'#f0f9ff',accent:'#fbbf24'} },
  ...
  { id:'major_21', name:{cn:'世界',en:'The World'},        suit:'major', number:21, rarity:'SSR',
    visual:{ image:null, symbolKey:'world',         palette:{bg:'#1a0a2e',primary:'#fbbf24',accent:'#a855f7'} },
  ...
  { id:'cups_01', name:{cn:'圣杯王牌',en:'Ace of Cups'},   suit:'cups', number:1,  rarity:'R',
    visual:{image:null,symbolKey:'cups',palette:_P.cups},
  ...
  { id:'cups_11', name:{cn:'圣杯侍从',en:'Page of Cups'},   suit:'cups', number:11, rarity:'R',
    visual:{image:null,symbolKey:'page',palette:{bg:'#080e1f',primary:'#93c5fd',accent:'#7dd3fc'}},
  ...
  { id:'cups_12', name:{cn:'圣杯骑士',en:'Knight of Cups'}, suit:'cups', number:12, rarity:'R',
    visual:{image:null,symbolKey:'knight',palette:{bg:'#080e1f',primary:'#93c5fd',accent:'#7dd3fc'}},
  ...
  { id:'cups_13', name:{cn:'圣杯王后',en:'Queen of Cups'},  suit:'cups', number:13, rarity:'SR',
    visual:{image:null,symbolKey:'queen',palette:{bg:'#080e1f',primary:'#93c5fd',accent:'#7dd3fc'}},
  ...
  { id:'cups_14', name:{cn:'圣杯国王',en:'King of Cups'},   suit:'cups', number:14, rarity:'SR',
    visual:{image:null,symbolKey:'king',palette:{bg:'#080e1f',primary:'#93c5fd',accent:'#7dd3fc'}},
  ...
  { id:'wands_01', name:{cn:'权杖王牌',en:'Ace of Wands'},   suit:'wands', number:1,  rarity:'R',
    visual:{image:null,symbolKey:'wands',palette:_P.wands},
  ...
  { id:'wands_11', name:{cn:'权杖侍从',en:'Page of Wands'},   suit:'wands', number:11, rarity:'R',
    visual:{image:null,symbolKey:'page',palette:{bg:'#1a0500',primary:'#fb923c',accent:'#fbbf24'}},
  ...
  { id:'wands_12', name:{cn:'权杖骑士',en:'Knight of Wands'}, suit:'wands', number:12, rarity:'R',
    visual:{image:null,symbolKey:'knight',palette:{bg:'#1a0500',primary:'#fb923c',accent:'#fbbf24'}},
  ...
  { id:'wands_13', name:{cn:'权杖王后',en:'Queen of Wands'},  suit:'wands', number:13, rarity:'R',
    visual:{image:null,symbolKey:'queen',palette:{bg:'#1a0500',primary:'#fb923c',accent:'#fbbf24'}},
  ...
  { id:'wands_14', name:{cn:'权杖国王',en:'King of Wands'},   suit:'wands', number:14, rarity:'SR',
    visual:{image:null,symbolKey:'king',palette:{bg:'#1a0500',primary:'#fb923c',accent:'#fbbf24'}},
  ...
  { id:'swords_01', name:{cn:'宝剑王牌',en:'Ace of Swords'},   suit:'swords', number:1,  rarity:'R',
    visual:{image:null,symbolKey:'swords',palette:_P.swords},
  ...
  { id:'swords_11', name:{cn:'宝剑侍从',en:'Page of Swords'},   suit:'swords', number:11, rarity:'R',
    visual:{image:null,symbolKey:'page',palette:{bg:'#100e00',primary:'#fde047',accent:'#fbbf24'}},
  ...
  { id:'swords_12', name:{cn:'宝剑骑士',en:'Knight of Swords'}, suit:'swords', number:12, rarity:'R',
    visual:{image:null,symbolKey:'knight',palette:{bg:'#100e00',primary:'#fde047',accent:'#fbbf24'}},
  ...
  { id:'swords_13', name:{cn:'宝剑王后',en:'Queen of Swords'},  suit:'swords', number:13, rarity:'SR',
    visual:{image:null,symbolKey:'queen',palette:{bg:'#100e00',primary:'#fde047',accent:'#fbbf24'}},
  ...
  { id:'swords_14', name:{cn:'宝剑国王',en:'King of Swords'},   suit:'swords', number:14, rarity:'SR',
    visual:{image:null,symbolKey:'king',palette:{bg:'#100e00',primary:'#fde047',accent:'#fbbf24'}},
  ...
  { id:'pentacles_01', name:{cn:'星币王牌',en:'Ace of Pentacles'},   suit:'pentacles', number:1,  rarity:'R',
    visual:{image:null,symbolKey:'pentacles',palette:_P.pentacles},
  ...
  { id:'pentacles_11', name:{cn:'星币侍从',en:'Page of Pentacles'},   suit:'pentacles', number:11, rarity:'R',
    visual:{image:null,symbolKey:'page',palette:{bg:'#030f08',primary:'#34d399',accent:'#86efac'}},
  ...
  { id:'pentacles_12', name:{cn:'星币骑士',en:'Knight of Pentacles'}, suit:'pentacles', number:12, rarity:'R',
    visual:{image:null,symbolKey:'knight',palette:{bg:'#030f08',primary:'#34d399',accent:'#86efac'}},
  ...
  { id:'pentacles_13', name:{cn:'星币王后',en:'Queen of Pentacles'},  suit:'pentacles', number:13, rarity:'R',
    visual:{image:null,symbolKey:'queen',palette:{bg:'#030f08',primary:'#34d399',accent:'#86efac'}},
  ...
  { id:'pentacles_14', name:{cn:'星币国王',en:'King of Pentacles'},   suit:'pentacles', number:14, rarity:'SR',
    visual:{image:null,symbolKey:'king',palette:{bg:'#030f08',primary:'#34d399',accent:'#86efac'}},
